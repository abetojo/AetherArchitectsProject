package ca.sheridancollege.sprints.security;

import ca.sheridancollege.sprints.database.DatabaseAccess;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername (String email) throws UsernameNotFoundException{
        ...
        ca.sheridancollege.sprints.beans.User user = da.findUserAccount(email);
        if(user == null)
        {
